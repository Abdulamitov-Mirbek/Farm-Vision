...
const Sidebar = () => {
      ...
      items: [
        {
          to: "/dashboard",
          icon: <Home size={18} />,
          label: sidebarText.dashboard[language],
        },
        {
          to: "/fields",
          icon: <Map size={18} />,
          label: sidebarText.fields[language],
        },
        {
          to: "/diary",
          icon: <BookOpen size={18} />,
          label: sidebarText.diary[language],
        },
        {
          to: "/calendar",
          icon: <Calendar size={18} />,
          label: sidebarText.calendar[language],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          label: sidebarText.animals[language],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          label: sidebarText.analytics[language],
        },
        {
          to: "/reports",
          icon: <FileText size={18} />,
          label: sidebarText.reports[language],
        },
        {
          to: "/forecasts",
          icon: <Cloud size={18} />,
          label: sidebarText.forecasts[language],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          label: sidebarText.weeklyTasks[language],
        },
        {
          to: "/work-plan",
          icon: <ClipboardList size={18} />,
          label: sidebarText.workPlan[language],
        },
        {
          to: "/resources",
          icon: <Tractor size={18} />,
          label: sidebarText.resources[language],
        },
      ],
    },
  ];
  ...
  const directoryItems = [
    {
      to: "/crops",
      icon: <Sprout size={18} />,
      label: sidebarText.crops[language],
    },
    {
      to: "/equipment",
      icon: <Settings size={18} />,
      label: sidebarText.equipment[language],
    },
    {
      to: "/employees",
      icon: <Users size={18} />,
      label: sidebarText.employees[language],
      adminOnly: true,
    },
    {
      to: "/suppliers",
      icon: <Handshake size={18} />,
      label: sidebarText.suppliers[language],
    },
  ];
  ...
  return (
    <aside
      className={`hidden lg:block w-64 border-r overflow-y-auto h-screen sticky top-0 transition-colors duration-300 ${themeClasses.sidebar} ${themeClasses.border}`}
    >
      {/* Фермерская информация */}
      {user && (
        <div
          className={`p-6 border-b transition-colors duration-300 ${themeClasses.border}`}
        >
          <div className="flex items-center space-x-3 mb-4">
            {/* Аватар */}
            <div
              className={`w-12 h-12 rounded-full ${themeClasses.avatar.bg} flex items-center justify-center text-white text-xl overflow-hidden border-4 ${themeClasses.avatar.border}`}
            >
              {avatar ? (
                <img
                  key={avatar}
                  ...
                  onError={(e) => {
                    // ✅ Только скрываем изображение, НЕ манипулируем родителем!
                    e.target.style.display = "none";
                    // Показываем запасной элемент через состояние (см. ниже)
                  }}
                />
              ) : (
          ...
          <div className="space-y-2">
            ...
            <div
              className={`w-full rounded-full h-2 ${themeClasses.progressBar.bg}`}
            >
              <div
        ...
        >
          ...
          <div className="flex-1">
            <div className="flex items-center">
              <span
                className={`font-bold ${theme === "dark" ? "text-purple-300" : "text-purple-700"}`}
              >
      ...
      <div className="p-4 space-y-6 overflow-y-auto">
        {navItems.map((section, index) => (
          <div key={index}>
            <h4
              className={`px-4 text-xs font-semibold uppercase tracking-wider mb-2 ${themeClasses.text.muted}`}
            >
              {section.title}
            </h4>
      ...
      <div
        className={`p-4 border-t transition-colors duration-300 ${themeClasses.border}`}
      >
